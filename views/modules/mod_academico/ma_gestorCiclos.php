                                            ...
                                            <div role="tabpanel" class="tab-pane fade in active" id="home_with_icon_title">
                                                ...
                                                <div class="card form-insert-academico" style="background: #f3f2f2; box-shadow: none; border: 1px solid #E5E4E4">
                                                    <div class="body">
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        <input type="text" name="createDeslarCiclo" class="form-control" placeholder="  Nombre completo" style="border-radius: 5px; height: 40px;">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        <input type="text" name="createDescorCiclo" class="form-control" placeholder="  Abreviatura" style="border-radius: 5px; height: 40px; margin-left: 10px;">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <?php 
                                                            $insert = new gestorCiclosController();
                                                            $insert -> createCiclosController();
                                                        ?>
                                                    </div>
                                                </div>
                                                <!-- TABLA DE LISTADO -->
                    									...
                    									<div class="table-responsive">
                    										<table class="table table-bordered table-striped table-hover js-basic-example dataTable text-center">
                                                                ...
                                                                <tbody style="font-size: 14px;">
                                                                    <?php 
                                                                            $ciclos = new gestorCiclosController();
                                                                            $ciclos -> getAllCiclosController();
                                                                            $ciclos -> updateCiclosController();
                                                                            $ciclos -> deleteCiclosController();
                                                                     ?>
                                                                </tbody>
                    		                                </table>
                    									</div>
