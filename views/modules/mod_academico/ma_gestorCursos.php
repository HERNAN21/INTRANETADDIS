            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12 col-lg-9">
                	<div class="block-header">
                        <h2>
                            MODULO DE TABLAS ACADEMICAS - <b>GESTOR DE CURSOS</b>
                        </h2>
                    </div>
                    <div class="row clearfix">
                                    ...
                                    <div class="body">
                                        ...
                                        <ul class="nav nav-tabs" role="tablist" style="margin-top: -15px;">
                                            <li role="presentation" class="active">
                                                <a href="#home_with_icon_title" data-toggle="tab">
                                                    <i class="material-icons">add_box</i> Creación de Cursos
                                                </a>
                                            </li>
                                            <li role="presentation">
                                                <a href="#profile_with_icon_title" data-toggle="tab">
                                                    <i class="material-icons">assignment_return</i> Asignación de ciclos a cursos
                                                </a>
                                            </li>
                                        </ul>
                                        <!-- Tab panes -->
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="home_with_icon_title">
                                                ...
                                                <div class="card form-insert-academico" style="background: #f3f2f2; box-shadow: none; border: 1px solid #E5E4E4">
                                                    <div class="body">
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        <input type="text" name="createDescorCurso" class="form-control" placeholder="  Nombre del Curso" style="border-radius: 5px; height: 35px;">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                    <div class="form-group">
                                                                        <input type="text" name="createDeslarCurso" class="form-control" placeholder="  Abreviatura" style="border-radius: 5px; height: 35px;">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2 col-md-3">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control" name="createCreditoCurso" style="border-radius: 5px; height: 35px; margin-left: 10px;" placeholder="Creditos">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <?php 
                                                            $insert = new gestorCursosController();
                                                            $insert -> createCursosController();
                                                        ?>
                                                    </div>
                                                </div>
                                                <!-- TABLA DE LISTADO -->
                    									...
                    									<div class="table-responsive">
                    										<table class="table table-bordered table-striped table-hover js-basic-example dataTable text-center">
                                                                ...
                                                                <tbody style="font-size: 14px;">
                                                                    <?php 
                                                                            $cursos = new gestorCursosController();
                                                                            $cursos -> getAllCursosController();
                                                                            $cursos -> updateCursosController();
                                                                            $cursos -> deleteCursosController();
                                                                     ?>
                                                                </tbody>
                    		                                </table>
                    									</div>
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="profile_with_icon_title">
                                                <div class="header">
                                                    <h2>
                                                        <strong>ASIGNAR CURSOS A CICLOS</strong>
                                                    </h2>
                                                    ...
                                                    <form class="form-horizontal" id="formInsertAsignacion" method="POST">
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="col-lg-2 col-md-2 col-sm-8 col-xs-7">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <input type="text" id="codCursoAsig" class="form-control" placeholder="Codigo" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                                                <label for="nomApell">CURSO</label>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-8 col-xs-7">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <input type="text" id="descCurso" class="form-control" placeholder="Curso" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <h6 class="text-muted text-center">DATOS DE CICLO</h6>
                                                        <hr>
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-5 col-xs-4">
                                                                <button type="button" class="btn btn-success waves-effect btn-sm col-md-6 col-sm-8 col-xs-12" onclick="insertCursoCiclo();">
                                                                    <i class="material-icons">save </i>
                                                                    <span>Agregar Curso</span>
                                                                </button>
                                                            </div>
                                                        ...
                                                        <div class="row clearfix">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="header">
                                                                    <h2>
                                                                        <strong>LISTA DE CURSOS -  CICLOS ACTUALES</strong>
                                                                    </h2>
                                                                </div>
                                                                ...
                                                                <div class="modal-body">
                                                                    <form id="formBuscarPerfil">
                                                                        <div class="form-group">
                                                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                                                <div class="form-line ">
                                                                                    <input type="text" class="form-control" id="searchCurso" placeholder="Nombre del perfil">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-3 col-sm-3 col-xs-3">
                                                                                <button type="submit" class="btn bg-deep-orange btn-sm waves-effect col-md-12 col-sm-12 col-xs-12" >
                                                                    ...
                                                                    <div class="row clearfix">
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <div class="body">
                                                                                <div class="table-responsive" id="dataCursos">
                                                                                    <!-- <table class="table table-bordered table-striped table-hover js-basic-example dataTable text-center" id="">
                                                                                            <thead>
                                                                                                <tr>
