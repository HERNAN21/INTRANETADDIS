...
class GestorCarrerasCursosModel{

	public function searchCarrerasModel($datosModel){

		$stmt = Conexion::conectaDB()->prepare("
				SELECT id_carrera, descor, deslar FROM carreras WHERE estado = 'AC' AND descor LIKE '%".$datosModel."%' OR deslar LIKE '%".$datosModel."%'
			");
	...
	public function getDataCarreraModel($datosModel, $tabla){

		$stmt = Conexion::conectaDB()->prepare("
				SELECT id_carrera, descor, deslar FROM $tabla WHERE id_carrera = :id_carrera
			");
